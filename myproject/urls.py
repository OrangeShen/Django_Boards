...
urlpatterns = [
    ...
    re_path('^reset/$', auth_views.PasswordResetView.as_view(
        template_name='password_reset.html',
        email_template_name='password_reset_email.html',
        subject_template_name='password_reset_subject.txt'
    ), name='password_reset'),
    re_path('^reset/done/$', auth_views.PasswordResetDoneView.as_view(
    ...
    re_path('^settings/password/$', auth_views.PasswordChangeView.as_view(
